...
type TypedSource[object client.Object, request mcreconcile.ClusterAware[request]] interface {
	ForCluster(multicluster.ClusterName, cluster.Cluster) (source.TypedSource[request], bool, error)
}
...
type TypedSyncingSource[object client.Object, request mcreconcile.ClusterAware[request]] interface {
	...
	SyncingForCluster(multicluster.ClusterName, cluster.Cluster) (source.TypedSyncingSource[request], bool, error)
